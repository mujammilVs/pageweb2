        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 h-full w-0 bg-gradient-to-r from-blue-500 to-blue-600 opacity-10 group-hover:w-full transition-all duration-500 z-0" />
