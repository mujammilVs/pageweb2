                ...
                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
                    <div className="flex items-center mb-4">
                      <div className={`bg-gradient-to-r ${item.color} p-2 rounded-lg mr-4`}>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Best Innovation</h4>
                <p className="text-sm text-gray-600">Tech Excellence Awards 2024</p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <Trophy className="h-8 w-8 text-blue-500 mx-auto mb-4" />
                <h4 className="font-semibold text-gray-900 mb-2">Top Employer</h4>
                <p className="text-sm text-gray-600">Great Place to Work 2024</p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <Users className="h-8 w-8 text-green-500 mx-auto mb-4" />
                <h4 className="font-semibold text-gray-900 mb-2">Customer Choice</h4>
                <p className="text-sm text-gray-600">Industry Leadership Awards</p>
              </div>
            </div>
          </div>
        </div>
