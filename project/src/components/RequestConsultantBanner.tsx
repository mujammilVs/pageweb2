...
const RequestConsultantBanner: React.FC = () => {
  const benefits = [
    {
      icon: CheckCircle,
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 mt-10">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      We'll analyze your current systems and identify
                      opportunities
                    </p>
                  </div>
                </div>
...
export default RequestConsultantBanner;
